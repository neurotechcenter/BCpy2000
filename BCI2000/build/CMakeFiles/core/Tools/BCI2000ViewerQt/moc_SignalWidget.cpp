...
#include "../../../../../src/core/Tools/BCI200~3/SignalWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SignalWidget_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject SignalWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SignalWidget.data,
    qt_meta_data_SignalWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SignalWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SignalWidget.stringdata0))
