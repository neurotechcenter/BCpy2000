...
GHIAMP_API		BOOL	__stdcall	GT_GetNumberOfSupportedBufferSizes(HANDLE hDevice, float samplingRate, int *numberOfSupportedBufferSizes);
GHIAMP_API		BOOL	__stdcall	GT_GetSupportedBufferSizes(HANDLE hDevice, float samplingRate, WORD *supportedBufferSizes);
