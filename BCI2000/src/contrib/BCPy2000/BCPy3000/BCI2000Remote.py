...
class BCI2000Remote(object):
    ...
    class _OperatorPath(object):
        ...
        def __set__(self, obj, val):
            obj._lib.BCI2000Remote_SetOperatorPath( obj._instance, ctypes.c_char_p( val.encode() ) ) 
    ...
    class _WindowTitle(object):
        ...
        def __set__(self, obj, val):
            obj._lib.BCI2000Remote_SetWindowTitle( obj._instance, ctypes.c_char_p( val.encode() ) )
    ...
    class _TelnetAddress(object):
        ...
        def __set__(self, obj, val):
            obj._lib.BCI2000Remote_SetTelnetAddress( obj._instance, ctypes.c_char_p( val.encode() ) )
    ...
    class _SubjectID(object):
        ...
        def __set__(self, obj, val):
            obj._lib.BCI2000Remote_SetSubjectID( obj._instance, ctypes.c_char_p( val.encode() ) )
    ...
    class _SessionID(object):
        ...
        def __set__(self, obj, val):
            obj._lib.BCI2000Remote_SetSessionID( obj._instance, ctypes.c_char_p( val.encode() ) )
    ...
    class _DataDirectory(object):
        ...
        def __set__(self, obj, val):
            obj._lib.BCI2000Remote_SetDataDirectory( obj._instance, ctypes.c_char_p( val.encode() ) )
    ...
    def Encode(self, val):
        return self._get_string_result( self._lib.BCI2000Remote_Encode, ctypes.c_char_p( val.encode() ) )
    ...
    def Execute(self, command, exitCode=[]):
        ...
        """
        i = ctypes.c_int()
        result = self._lib.BCI2000Remote_Execute( self._instance, ctypes.c_char_p( command.encode() ), ctypes.byref( i ) )
        exitCode.append( i )
        return result
    ...
    def StartupModules(self, modules):
        ...
        modulestring = "\0".join( str(i) for i in modules ) + "\0"
        return self._lib.BCI2000Remote_StartupModules( self._instance, modulestring )

    def LoadParametersLocal(self, file):
        return self._lib.BCI2000Remote_LoadParametersLocal( self._instance, ctypes.c_char_p( file.encode() ) )
    
    def LoadParametersRemote(self, file):
        return self._lib.BCI2000Remote_LoadParametersRemote( self._instance, ctypes.c_char_p( file.encode() ) )
    ...
    def SetParameter(self, name, value):
        return self._lib.BCI2000Remote_SetParameter( self._instance, ctypes.c_char_p( name.encode() ), ctypes.c_char_p( value.encode() ) )

    def GetParameter(self, name):
        return self._get_string_result( self._lib.BCI2000Remote_GetParameter, ctypes.c_char_p( name.encode() ) )
    ...
    def AddStateVariable(self, name, bit_width, initial_value):
        return self._lib.BCI2000Remote_AddStateVariable( self._instance, ctypes.c_char_p( name.encode() ), ctypes.c_int( bit_width ), ctypes.c_double( initial_value ) )

    def SetStateVariable(self, name, val):
        result = self._lib.BCI2000Remote_SetStateVariable( self._instance, ctypes.c_char_p( name.encode() ), ctypes.c_double( val ) )
        if not result:
            raise self._object_error

    def GetStateVariable(self, name):
        result = ctypes.c_double()
        if not self._lib.BCI2000Remote_GetStateVariable( self._instance, ctypes.c_char_p( name.encode() ), ctypes.byref( result ) ):
          raise self._object_error

    def SetScript(self, event, script):
        return self._lib.BCI2000Remote_SetScript( self._instance, ctypes.c_char_p( event.encode() ), ctypes.c_char_p( script.encode() ) )

    def GetScript(self, event):
        return self._get_string_result( self._lib.BCI2000Remote_GetScript, ctypes.c_char_p( event.encode() ) )
