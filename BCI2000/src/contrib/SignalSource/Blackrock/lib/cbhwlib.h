...
// $Revision: 5304 $
// $Date: 2016-03-26 18:47:03 -0400 (Sat, 26 Mar 2016) $
// $Author: gmilsap $
//
// $NoKeywords: $
//
...
// CBSDK MADE A BACKWARD-INCOMPATIBLE CHANGE
// THIS IS A VERY UNTESTED HACK OF A FIX, SO 
// BE AWARE OF YOUR EXTRAORDINARILY LIMITED KARMA

#define cbVERSION_MINOR 9 // Uncomment if you use firmware 6.04 and below
//#define cbVERSION_MINOR 10 // Uncomment if you use firmware 6.05 and above

// Version history:
//  TEMPORARY HACK TO SUPPORT NEW FIRMWARES - Griff
