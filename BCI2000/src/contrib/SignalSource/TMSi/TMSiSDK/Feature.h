...
{	public:
		...
		BOOLEAN GetRtcTime(IN LPSYSTEMTIME Time );
		BOOLEAN GetRtcAlarmTime(IN LPSYSTEMTIME Time );
		BOOLEAN SetRtcTime(IN LPSYSTEMTIME Time );
		BOOLEAN SetRtcAlarmTime(IN LPSYSTEMTIME Time );
