...
{	FEATURE_DATA Feature;
	float Highpass[1];
}FEATURE_HIGHPASS , *PFEATURE_HIGHPASS;
...
{	FEATURE_DATA Feature;
	float Lowpass[1];
}FEATURE_LOWPASS , *PFEATURE_LOWPASS;
...
{	FEATURE_DATA Feature;
	float Offset[1];
}FEATURE_OFFSET , *PFEATURE_OFFSET;
...
{	FEATURE_DATA Feature;
	float Gain;
	float Offset;
}FEATURE_CORRECTION, *PFEATURE_CORRECTION;
