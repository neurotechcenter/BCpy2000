...
BOOLEAN RTDeviceEx::GetRtcTime(OUT LPSYSTEMTIME Time )
{	FEATURE_RTC RtcData;
	ULONG InSize;
...
//
BOOLEAN RTDeviceEx::GetRtcAlarmTime(OUT LPSYSTEMTIME Time )
{	FEATURE_RTC RtcData;
	//Check input parameters
	if( Time == NULL ) return FALSE;
...
BOOLEAN RTDeviceEx::SetRtcTime(IN LPSYSTEMTIME Time )
{	FEATURE_RTC RtcData;
	//Check input parameters
	if( Time == NULL ) return FALSE;
...
BOOLEAN RTDeviceEx::SetRtcAlarmTime(IN LPSYSTEMTIME Time )
{	FEATURE_RTC RtcData;
	//Check input parameters
	if( Time == NULL ) return FALSE;
