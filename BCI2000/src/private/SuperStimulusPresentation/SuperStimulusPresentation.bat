...
#######################################################################################
## $Id: SuperStimulusPresentation_SignalGenerator.bat 4126 2013-11-14 14:21:28Z jgoldberg $
...
Start executable SuperStimulusPresentation --local
Wait for Connected
Load parameterfile "../parms/examples/SuperStimulusPresentation_SignalGenerator.prm"
