...
// SLAB_USB_SPI.h
//-----------------------------------------------------------------------------
// Copyright 2012-2015 Silicon Laboratories Inc.
// http://www.silabs.com
//-----------------------------------------------------------------------------
...
#define SLAB_USB_SPI_API     __declspec(dllexport)
#else
...
typedef unsigned int                USB_SPI_STATUS;	// See USB_SPI_ERRCODE_* below
/// @}
...
#define USB_SPI_ERRCODE_UNKNOWN_ERROR                   0xFFFFFFFF  /// Unknown/unspecified error.  TODO: No, not all-F's, how about 0xFF?
/// @}
...
_Check_return_
_Ret_range_(USB_SPI_ERRCODE_SUCCESS, USB_SPI_ERRCODE_UNKNOWN_ERROR)
...
SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_GetOpenedVidPid          ( CP213x_DEVICE device, _Out_writes_bytes_opt_(2) WORD* vid, _Out_writes_bytes_opt_(2) WORD* pid );
...
SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_GetDeviceVersion         ( CP213x_DEVICE hDevice, _Out_writes_bytes_opt_(1) BYTE* majorVersion, _Out_writes_bytes_opt_(1) BYTE* minorVersion );
...
SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_GetManufacturingString   ( CP213x_DEVICE hDevice, LPSTR manufacturingString, BYTE* manufacturingStringLen);
...
SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_TransferReadSync         ( _In_ CP213x_DEVICE hDevice,
                                  BYTE pReadBuf[],
                                  DWORD length,
                                  BOOL releaseBusAfterTransfer,
                                  DWORD timeoutMs,
...
SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_SetFifoFullThreshold     ( CP213x_DEVICE hDevice, _In_ const BYTE fifoFullThreshold );
...
SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_GetGpioModeAndLevel      (_In_ CP213x_DEVICE hDevice, _In_ _In_range_(0, CP213x_NUM_GPIO-1) const BYTE channel, _Out_writes_bytes_opt_(1) BYTE* mode, _Out_writes_bytes_opt_(1) BYTE* level );

SLAB_USB_SPI_API USB_SPI_STATUS WINAPI
CP213x_SetGpioModeAndLevel      (_In_ CP213x_DEVICE hDevice, _In_ _In_range_(0, CP213x_NUM_GPIO-1) const BYTE channel, const BYTE mode, const BYTE level );
