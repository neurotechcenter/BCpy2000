...
public:
  ...
  void SetBorderColor(const RGBColor& color) {mBorderColor = color; }
  RGBColor& Color() { return mColor; }
  RGBColor& BorderColor() { return mBorderColor; }
  void SetExpansion( double val ) { mExpansion = val; }
  double Expansion() { return mExpansion; }
  void SetValue(const double& val) { mValue = val; }
