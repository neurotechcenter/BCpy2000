...
#######################################################################################
## $Id: StimulusPresentation_gUSBamp.bat 4126 2012-06-15 17:42:57Z mellinger $
...
Start executable NihonKohdenSource --local
...
Load parameterfile "../parms/fragments/amplifiers/NihonKohden.prm"