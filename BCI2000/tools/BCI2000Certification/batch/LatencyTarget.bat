...
cd ..\..\..\prog
start operat.exe --OnConnect "-LOAD PARAMETERFILE ..\tools\BCI2000Certification\parms\latencyTest.prm; LOAD PARAMETERFILE ..\tools\BCI2000Certification\parms\latencyTarget.prm; SETCONFIG;" --OnSuspend "-QUIT"
wait 0
